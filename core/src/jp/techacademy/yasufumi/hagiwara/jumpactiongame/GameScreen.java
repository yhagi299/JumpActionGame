...
/**
 * Created by hagiwara on 2018/02/23.
 */
...
public class GameScreen extends ScreenAdapter{
    ...
    static final int GAME_STATE_PLAYINNG = 1;
    ...
    Sound mFail_tone = Gdx.audio.newSound(Gdx.files.internal("data/fail_tone.mp3"));
    ...
    public GameScreen(JumpActionGame game){
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.yasufumi.hagiwara.jumpactiongame");
    ...
    private void createStage(){
        ...
        while (y < WORLD_HEIGHT - 5){
            ...
            if (mRandom.nextFloat() > 0.6f){
                ...
                star.setPosition(step.getX() + mRandom.nextFloat(), step.getY() + Star.START_HEIGHT + mRandom.nextFloat() * 3 );
                mStars.add(star);
            }
    ...
    private void updateReady() {
        if(Gdx.input.justTouched()){
            mGameState = GAME_STATE_PLAYINNG;
        }
    }
